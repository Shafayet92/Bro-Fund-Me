          ...
          <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-default">
              <div class="panel-body">
                <img class="don" src="assets/images/donate-1.jpg" style="width:30%;height:30%;display: block; margin-left: auto; margin-right: auto;"  >
                ...
                <form action="check_login.php" method="post">
                  ...
                  <div class="row">
                    <div class="col-lg-8">
                      <b><a href="forgetpassword.php">Forgot password?</a></b>
                    </div>
